...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../.symlinks/plugins/flutter_embed_unity_2022_3_ios/ios/UnityFramework.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_embed_unity_2022_3_ios/flutter_embed_unity_2022_3_ios.framework"
