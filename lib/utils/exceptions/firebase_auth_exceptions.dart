...
class MAppFirebaseAuthException implements Exception {
  /// The error code associated with the exception
  final String code;

  /// Constructor that takes an error code
  MAppFirebaseAuthException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'invalid-credential':
        return 'The provided credential is incorrect or has expired.';
      // case 'wrong-password':
      ...
      // case 'invalid-credential':
      //   return 'The provided credential is invalid. Please check the credential and try again.';
